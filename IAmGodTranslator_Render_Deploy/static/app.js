...
function renderDetail() {
  ...
  els.downloadBackup.onclick = () => toast("Full backup/restore is disabled on Render Free. Use ZIP exports/imports.", true);
...
function registerServiceWorker() { if (!("serviceWorker" in navigator)) return; navigator.serviceWorker.register("/service-worker.js?v=18").then((registration) => registration.update()).catch(() => {}); }
